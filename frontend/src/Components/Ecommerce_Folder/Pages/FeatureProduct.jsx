...
const FeatureProduct = () => {
  ...
  const products = [
    {
      ...
      description: "Premium high-flow air filter designed to increase horsepower and torque. Features washable and reusable design with lifetime warranty.",
      features: [
      ...
      images: [
        "NEW7000_1-1000x1000-1100x1100 (1).jpg"
      ]
    },
    {
      id: 2,
      ...
      save: "Save $600",
      badge: "24% OFF",
      imageUrl: "https://images.unsplash.com/photo-1549399542-7e3f8b79c341?w=500&h=350&fit=crop",
      category: "Wheels & Tires",
      description: "Lightweight forged alloy wheels for superior performance and style.",
      features: [
    ...
    },
    {
      ...
      save: "Save $150",
      badge: "NEW",
      imageUrl: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=500&h=350&fit=crop",
      category: "Lighting",
    ...
    },
    {
      ...
      save: "Save $300",
      badge: "TOP RATED",
      imageUrl: "https://images.unsplash.com/photo-1627560116075-1c7c850d6e8c?w=500&h=350&fit=crop",
      category: "Exhaust",
  ...
  return (
    <div className="feature-products-container">
      ...
      <p className="feature-products-subtitle">Upgrade your vehicle with our premium selection</p>
            ...
            <div className="image-wrapper">
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  e.target.src = "https://via.placeholder.com/500x350/3b82f6/ffffff?text=Product+Image";
                }}
              />
            </div>
